...
@Component({
  styleUrls: ['../resources/main.css', '../resources/material-design-lite/material.min.css', '../resources/material-design-lite/expansion-panel.css'],
  selector: 'sidebar',
  template: `   
